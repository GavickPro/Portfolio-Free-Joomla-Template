...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<fieldset class="contact__fieldset">
		<?php if ($this->params->get('filter_field') != 'hide') :?>
			<div class="contact__form_left">
				<label class="filter-search-lbl" for="filter-search"><?php echo JText::_('COM_CONTACT_FILTER_LABEL') . '&#160;'; ?></label>
					...
					<li class="contact__item">
						<div>
							<div class="contact__header">
								<a href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid)); ?>" class="contact__header_title">
									<?php echo $item->name; ?>
								</a>
							</div>
