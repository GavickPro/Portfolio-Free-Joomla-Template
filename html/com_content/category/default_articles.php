		...
		<thead>
			<tr>
				<th id="categorylist_header_title">
					<?php echo str_replace('hasTooltip', '', JHtml::_('grid.sort', 'JGLOBAL_TITLE', 'a.title', $listDirn, $listOrder)); ?>
				</th>
				<?php if ($date = $this->params->get('list_show_date')) : ?>
					<th id="categorylist_header_date">
						<?php if ($date == "created") : ?>
							<?php echo str_replace('hasTooltip', '', JHtml::_('grid.sort', 'COM_CONTENT_' . $date . '_DATE', 'a.created', $listDirn, $listOrder)); ?>
						<?php elseif ($date == "modified") : ?>
							<?php echo str_replace('hasTooltip', '', JHtml::_('grid.sort', 'COM_CONTENT_' . $date . '_DATE', 'a.modified', $listDirn, $listOrder)); ?>
						<?php elseif ($date == "published") : ?>
							<?php echo str_replace('hasTooltip', '', JHtml::_('grid.sort', 'COM_CONTENT_' . $date . '_DATE', 'a.publish_up', $listDirn, $listOrder)); ?>
						<?php endif; ?>
					</th>
				<?php endif; ?>
				<?php if ($this->params->get('list_show_author')) : ?>
					<th id="categorylist_header_author">
						<?php echo str_replace('hasTooltip', '', JHtml::_('grid.sort', 'JAUTHOR', 'author', $listDirn, $listOrder)); ?>
					</th>
				<?php endif; ?>
				<?php if ($this->params->get('list_show_hits')) : ?>
					<th id="categorylist_header_hits">
						<?php echo str_replace('hasTooltip', '', JHtml::_('grid.sort', 'JGLOBAL_HITS', 'a.hits', $listDirn, $listOrder)); ?>
					</th>
				<?php endif; ?>
				<?php if ($isEditable) : ?>
