...
?>
	...
	<dt class="result__title <?php echo $mime; ?>">
		<span class="result__counter"><?php echo $this->pagination->limitstart + $this->key + 1; ?></span>
		<a href="<?php echo JRoute::_($route); ?>" class="result__title_link"><?php echo $this->result->title; ?></a>
	</dt>
